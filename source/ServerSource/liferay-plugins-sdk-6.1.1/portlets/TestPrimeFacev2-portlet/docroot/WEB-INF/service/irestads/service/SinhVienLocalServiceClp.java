 ...
 * @author ADMIN
 */
public class SinhVienLocalServiceClp implements SinhVienLocalService {
	public SinhVienLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodName19 = "getSinhVienByLop";

		_methodParameterTypes19 = new String[] { "long" };

		_methodName20 = "getAllSinhVien";
	...
	public irestads.model.SinhVien addSinhVien(irestads.model.SinhVien sinhVien)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(sinhVien) });
		}
		catch (Throwable t) {
		...
		return (irestads.model.SinhVien)ClpSerializer.translateOutput(returnObj);
	}
	...
	public irestads.model.SinhVien createSinhVien(long sinhVienId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { sinhVienId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.SinhVien deleteSinhVien(long sinhVienId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { sinhVienId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.SinhVien fetchSinhVien(long sinhVienId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { sinhVienId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.SinhVien getSinhVien(long sinhVienId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { sinhVienId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<irestads.model.SinhVien> getSinhViens(int start,
		...
		return (java.util.List<irestads.model.SinhVien>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public irestads.model.SinhVien updateSinhVien(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(sinhVien), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<irestads.model.SinhVien> getSinhVienByLop(long lopId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName19,
					_methodParameterTypes19, new Object[] { lopId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
