...
public class FooWrapper implements Foo, ModelWrapper<Foo> {
	...
	*/
	...
	public int compareTo(iRestads.model.Foo foo) {
	...
	public com.liferay.portal.model.CacheModel<iRestads.model.Foo> toCacheModel() {
		return _foo.toCacheModel();
	}

	public iRestads.model.Foo toEscapedModel() {
