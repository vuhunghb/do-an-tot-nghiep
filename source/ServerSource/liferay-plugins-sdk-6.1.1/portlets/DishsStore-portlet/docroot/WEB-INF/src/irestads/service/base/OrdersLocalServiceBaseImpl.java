...
/**
 * The base implementation of the orders local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link irestads.service.impl.OrdersLocalServiceImpl}.
 * </p>
 *
 * @author Be
...
public abstract class OrdersLocalServiceBaseImpl extends BaseLocalServiceImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link irestads.service.OrdersLocalServiceUtil} to access the orders local service.
	 */
	...
	public Orders addOrders(Orders orders) throws SystemException {
		...
		return ordersPersistence.update(orders, false);
	}
	...
	public Orders updateOrders(Orders orders) throws SystemException {
		return updateOrders(orders, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Orders updateOrders(Orders orders, boolean merge)
		throws SystemException {
		orders.setNew(false);

		return ordersPersistence.update(orders, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("irestads.model.Orders",
			ordersLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"irestads.model.Orders");
	}
