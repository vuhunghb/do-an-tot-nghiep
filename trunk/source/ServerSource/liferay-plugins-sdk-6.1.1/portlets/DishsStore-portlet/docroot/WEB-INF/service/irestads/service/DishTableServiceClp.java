 ...
 * @author Be
 */
public class DishTableServiceClp implements DishTableService {
	public DishTableServiceClp(InvokableService invokableService) {
	...
	public irestads.model.DishTable updateDishTable(irestads.model.DishTable dt) {
		...
		try {
			returnObj = _invokableService.invokeMethod(_methodName4,
					...
					new Object[] { ClpSerializer.translateInput(dt) });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
