 ...
 * @author Be
 */
public class DishTableLocalServiceClp implements DishTableLocalService {
	public DishTableLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public irestads.model.DishTable addDishTable(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(dishTable) });
		}
		catch (Throwable t) {
	...
	public irestads.model.DishTable updateDishTable(
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(dishTable), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
