 ...
 * @author Be
 */
public class DishLocalServiceClp implements DishLocalService {
	public DishLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public irestads.model.Dish createDish(long dishId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { dishId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.Dish deleteDish(long dishId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { dishId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.Dish fetchDish(long dishId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { dishId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.Dish updateDish(irestads.model.Dish dish,
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(dish), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
