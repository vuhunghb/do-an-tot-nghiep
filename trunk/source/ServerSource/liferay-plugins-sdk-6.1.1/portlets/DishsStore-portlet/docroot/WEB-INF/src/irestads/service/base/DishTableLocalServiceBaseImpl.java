...
/**
 * The base implementation of the dish table local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link irestads.service.impl.DishTableLocalServiceImpl}.
 * </p>
 *
 * @author Be
 ...
 * @generated
 */
public abstract class DishTableLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements DishTableLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link irestads.service.DishTableLocalServiceUtil} to access the dish table local service.
	 */
	...
	public DishTable addDishTable(DishTable dishTable)
		throws SystemException {
		dishTable.setNew(true);

		return dishTablePersistence.update(dishTable, false);
	}
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public DishTable deleteDishTable(DishTable dishTable)
		throws SystemException {
		return dishTablePersistence.remove(dishTable);
	}

	public DynamicQuery dynamicQuery() {
		Class<?> clazz = getClass();

		return DynamicQueryFactoryUtil.forClass(DishTable.class,
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dishTablePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dishTablePersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dishTablePersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DishTable> getDishTables(int start, int end)
		throws SystemException {
		return dishTablePersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDishTablesCount() throws SystemException {
		return dishTablePersistence.countAll();
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DishTable updateDishTable(DishTable dishTable)
		throws SystemException {
		return updateDishTable(dishTable, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public DishTable updateDishTable(DishTable dishTable, boolean merge)
		throws SystemException {
		dishTable.setNew(false);

		return dishTablePersistence.update(dishTable, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("irestads.model.DishTable",
			dishTableLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"irestads.model.DishTable");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dishTablePersistence.getDataSource();
	...
	private DishTableLocalServiceClpInvoker _clpInvoker = new DishTableLocalServiceClpInvoker();
}