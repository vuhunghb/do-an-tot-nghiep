...
/**
 * The base implementation of the menu local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link irestads.service.impl.MenuLocalServiceImpl}.
 * </p>
 *
 * @author Be
...
public abstract class MenuLocalServiceBaseImpl extends BaseLocalServiceImpl
	implements MenuLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link irestads.service.MenuLocalServiceUtil} to access the menu local service.
	 */
	...
	public Menu addMenu(Menu menu) throws SystemException {
		menu.setNew(true);

		return menuPersistence.update(menu, false);
	}
	...
	public Menu deleteMenu(long menuId) throws PortalException, SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.DELETE)
	public Menu deleteMenu(Menu menu) throws SystemException {
	...
	public Menu fetchMenu(long menuId) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public Menu getMenu(long menuId) throws PortalException, SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Menu> getMenus(int start, int end) throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getMenusCount() throws SystemException {
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Menu updateMenu(Menu menu) throws SystemException {
		return updateMenu(menu, true);
	}
	 ...
	 */
	@Indexable(type = IndexableType.REINDEX)
	public Menu updateMenu(Menu menu, boolean merge) throws SystemException {
		menu.setNew(false);

		return menuPersistence.update(menu, merge);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("irestads.model.Menu",
			menuLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister("irestads.model.Menu");
	}
	...
	private MenuLocalServiceClpInvoker _clpInvoker = new MenuLocalServiceClpInvoker();
}