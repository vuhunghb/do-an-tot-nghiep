...
public class AdsItemPersistenceImpl extends BasePersistenceImpl<AdsItem>
	 ...
	 * @throws irestads.NoSuchItemException if a ads item with the primary key could not be found
	...
	/**
	 * Returns the ads item with the primary key or throws a {@link irestads.NoSuchItemException} if it could not be found.
	 *
	 * @param adsItemId the primary key of the ads item
	 * @return the ads item
	 * @throws irestads.NoSuchItemException if a ads item with the primary key could not be found
	 ...
	 * @throws irestads.NoSuchItemException if a matching ads item could not be found
	 * @throws SystemException if a system exception occurred
	 */
