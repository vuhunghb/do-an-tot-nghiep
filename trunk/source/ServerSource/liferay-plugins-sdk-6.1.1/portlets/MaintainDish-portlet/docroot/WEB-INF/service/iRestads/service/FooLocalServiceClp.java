...
public class FooLocalServiceClp implements FooLocalService {
	public FooLocalServiceClp(InvokableLocalService invokableLocalService) {
		...
		_methodParameterTypes0 = new String[] { "iRestads.model.Foo" };
		...
		_methodParameterTypes3 = new String[] { "iRestads.model.Foo" };
		...
		_methodParameterTypes14 = new String[] { "iRestads.model.Foo" };

		_methodName15 = "updateFoo";

		_methodParameterTypes15 = new String[] { "iRestads.model.Foo", "boolean" };
	...
	public iRestads.model.Foo addFoo(iRestads.model.Foo foo)
		...
		return (iRestads.model.Foo)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<iRestads.model.Foo> getFoos(int start, int end)
		...
		return (java.util.List<iRestads.model.Foo>)ClpSerializer.translateOutput(returnObj);
	}
