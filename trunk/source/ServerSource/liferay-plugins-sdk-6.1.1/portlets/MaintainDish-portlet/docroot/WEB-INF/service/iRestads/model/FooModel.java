...
/**
 * The base model interface for the Foo service. Represents a row in the &quot;a_Foo&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link iRestads.model.impl.FooModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link iRestads.model.impl.FooImpl}.
 * </p>
 *
 * @author Be
 * @see Foo
 * @see iRestads.model.impl.FooImpl
 * @see iRestads.model.impl.FooModelImpl
 * @generated
 */
