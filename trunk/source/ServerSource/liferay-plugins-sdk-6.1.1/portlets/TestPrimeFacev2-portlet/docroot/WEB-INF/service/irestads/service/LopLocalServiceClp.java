 ...
 * @author ADMIN
 */
public class LopLocalServiceClp implements LopLocalService {
	public LopLocalServiceClp(InvokableLocalService invokableLocalService) {
	...
	public irestads.model.Lop addLop(irestads.model.Lop lop)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName0,
					...
					new Object[] { ClpSerializer.translateInput(lop) });
		}
		catch (Throwable t) {
		...
		return (irestads.model.Lop)ClpSerializer.translateOutput(returnObj);
	}
	...
	public irestads.model.Lop createLop(long lopId) {
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName1,
					_methodParameterTypes1, new Object[] { lopId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.Lop deleteLop(long lopId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName2,
					_methodParameterTypes2, new Object[] { lopId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.Lop fetchLop(long lopId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName9,
					_methodParameterTypes9, new Object[] { lopId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public irestads.model.Lop getLop(long lopId)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName10,
					_methodParameterTypes10, new Object[] { lopId });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
	...
	public java.util.List<irestads.model.Lop> getLops(int start, int end)
		...
		return (java.util.List<irestads.model.Lop>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public irestads.model.Lop updateLop(irestads.model.Lop lop, boolean merge)
		...
		try {
			returnObj = _invokableLocalService.invokeMethod(_methodName15,
					...
					new Object[] { ClpSerializer.translateInput(lop), merge });
		}
		catch (Throwable t) {
			t = ClpSerializer.translateThrowable(t);
