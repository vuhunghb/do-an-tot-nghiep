...
/**
 * The utility for the sinh vien local service. This utility wraps {@link irestads.service.impl.SinhVienLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @generated
 */
public class SinhVienLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link irestads.service.impl.SinhVienLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static irestads.model.SinhVien addSinhVien(
		irestads.model.SinhVien sinhVien)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().addSinhVien(sinhVien);
	}
	...
	*/
	public static irestads.model.SinhVien createSinhVien(long sinhVienId) {
		return getService().createSinhVien(sinhVienId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static irestads.model.SinhVien deleteSinhVien(long sinhVienId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSinhVien(sinhVienId);
	}
	...
	*/
	public static irestads.model.SinhVien deleteSinhVien(
		irestads.model.SinhVien sinhVien)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteSinhVien(sinhVien);
	}
	...
	*/
	...
	public static irestads.model.SinhVien fetchSinhVien(long sinhVienId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchSinhVien(sinhVienId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static irestads.model.SinhVien getSinhVien(long sinhVienId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getSinhVien(sinhVienId);
	}
	...
	*/
	public static java.util.List<irestads.model.SinhVien> getSinhViens(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSinhViens(start, end);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static int getSinhViensCount()
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().getSinhViensCount();
	}
	...
	*/
	public static irestads.model.SinhVien updateSinhVien(
		irestads.model.SinhVien sinhVien)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSinhVien(sinhVien);
	}
	...
	*/
	public static irestads.model.SinhVien updateSinhVien(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateSinhVien(sinhVien, merge);
	}
	...
	*/
	...
	public static SinhVienLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					SinhVienLocalService.class.getName());

			if (invokableLocalService instanceof SinhVienLocalService) {
				_service = (SinhVienLocalService)invokableLocalService;
			}
			else {
				_service = new SinhVienLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(SinhVienLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(SinhVienLocalService service) {
	}

	private static SinhVienLocalService _service;
}